...
This sequence behavior tells us two things:
    ...
    For N>1000N > 1000N>1000, suppose the number has ‘M’ digits and the next number is ‘N1’. From the above Wikipedia link, we know that the sum of the squares of the digits of ‘N’ is at most 92M9^2M9​2​​M, or 81M81M81M (this will happen when all digits of ‘N’ are ‘9’).
