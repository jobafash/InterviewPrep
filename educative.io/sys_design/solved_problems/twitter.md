...
(100M/5 photos _ 200KB) + (100M/10 videos _ 2MB) ~= 24TB/day
...
Returns: (string)
A successful post will return the URL to access that tweet. Otherwise, an appropriate HTTP error is returned. 5. High Level System Design
...
86400 sec/day _ 365 (days a year) _ 50 (years) => 1.6B
...
By monitoring these counters, we will realize if we need more replication, load balancing, or caching. 13. Extended Requirements
